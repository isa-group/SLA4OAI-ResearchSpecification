...
| serviceProperties    | [`[ServiceProperty]`](#markdown-header-servicepropertyobject) | **Optional** When present, provides some SLA constrains to apply to the current service invocation. Quota or Rate limit info can be used to inform the client. |
